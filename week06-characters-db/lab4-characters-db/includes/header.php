      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            ...
            <a class="nav-link" href="<?php echo BASE_URL ?>listalt.php">List</a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="<?php echo BASE_URL ?>admin/login-insert.php">Insert</a>
              <a class="dropdown-item" href="<?php echo BASE_URL ?>admin/login-edit.php">Edit</a>
