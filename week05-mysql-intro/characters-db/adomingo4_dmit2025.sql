...
--
-- Host: localhost
-- Generation Time: Oct 21, 2020 at 11:55 AM
...
INSERT INTO `characters` (`first_name`, `last_name`, `age`, `occupation`, `description`, `id`) VALUES
('Homer', 'Simpson', 34, 'Nuclear Worker', 'The big guy. The patriarch of the Simpson family. Homers son.', 1),
('Arr', 'Domingo', 20, 'software engineer', 'This is a test\\\\r\\\\n', 5),
('Girlie', 'gesmundooooooooooo', 52, 'nurse', 'beagdgdhdjd', 9),
('Homer', 'test', 44, 'software engineer', 'fdfasdg', 21);
...
INSERT INTO `test` (`username`, `address`, `occupation`, `id`) VALUES
('Fred Flinstone', '123 Bedrock Avenue', 'Quarry Worker', 1),
('Barney Rubble', '456 Bedrock Avenue', 'Truck Driver', 2),
('BamBam1 Rubble', '789 Main St.', 'Child', 20),
('arr', 'edmonton', 'software engineer', 23),
('', '', '', 24),
('snowman', 'edmonton', 'software engineer', 27),
('BamBam1 Rubble', '456 Bedrock Avenue', 'Child', 28),
('', '', '', 29),
('', '', '', 30),
('', '', '', 31),
('', '', '', 32),
