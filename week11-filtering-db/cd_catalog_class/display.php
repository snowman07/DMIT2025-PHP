...
if(isset($displayby) && isset($displayvalue)) {
	...
	$result = mysqli_query($con,"SELECT * FROM cd_catalog_class WHERE $displayby LIKE '$displayvalue' ") or die (mysql_error());
...
TASK: Here, create several links for the following:
 - 3 more genre links -->
<a href="display.php?displayby=genre&displayvalue=rock">Genre:Rock</a><br />
<a href="display.php?displayby=genre&displayvalue=world">Genre:World</a><br />
<a href="display.php?displayby=genre&displayvalue=pop">Genre:Pop</a><br />

<!-- - One year that is represented by several CD's in the collection -->
<a href="display.php?displayby=year&displayvalue=2000">Year:2000</a><br />

<!-- - One link to a certain record label that is represented by several CD's in the collection -->
<a href="display.php?displayby=label&displayvalue=jive">Label:Jive</a><br />
